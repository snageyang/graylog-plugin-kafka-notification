...
module.exports = new PluginWebpackConfig('com.ucap.cloud.graylog.plugin.kafka.notification.KafkaNotificationPlugin', loadBuildConfig(path.resolve(__dirname, './build.config')), {
